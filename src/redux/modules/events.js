...
export const EVENT_FETCH_SAVED_PENDING = 'feuc/events/EVENT_FETCH_SAVED_PENDING';
export const EVENT_FETCH_SAVED_FULFILLED = 'feuc/events/EVENT_FETCH_SAVED_FULFILLED';
export const EVENT_FETCH_SAVED_REJECTED = 'feuc/events/EVENT_FETCH_SAVED_REJECTED';
...
export const fetchEventsSaved = options => (dispatch, getState, { client }) => dispatch({
