...
export const SESSION_REGISTER_FULFILLED =
  "feuc/session/SESSION_REGISTER_FULFILLED";
export const SESSION_REGISTER_REJECTED =
  "feuc/session/SESSION_REGISTER_REJECTED";
...
// Action creators
export const register = (data, options) => (dispatch, getState, { client }) =>
  dispatch({
